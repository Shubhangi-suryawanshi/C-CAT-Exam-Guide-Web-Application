            ...
            <div class="card social-widget-card bg-primary">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <span class="ml-2"><i class="fas fa-book"></i></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card social-widget-card bg-danger">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <span class="ml-2"><i class="fas fa-users"
                                    ></i></span>
                        </div>
                    </div>
                </div>
    ...
    <div class="jumbotron ">
        <div class="row justify-content-between">
            ...
            <div class="col-4 justify-content-center m-auto">
                        <a className="btn btn-link btn-block" ><Link to={"/dashboard"}>Back To Dashboard</Link></a>
                        </div>
        </div>
    </div>
</div>
                        ...
                        <div class="card shadow-base card-body pd-25 bd-0">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="test-report-icon report_rank">
                                        <div class="rank-circle mb-5">
                                            <span class="mx-2"><i class="fas fa-award"
                                                    ></i></span>
                                            <span class="text-danger h5 mx-0"><b>Percentage :</b>80%</span>
                                        </div>

                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-6 col-md-6 text-center my-2">
                                            <p class="text-muted m-b-5 f-12"><i class="fas fa-list-ol"></i> Total
                                                Question :</p>
                                            <h6 class="f-w-600"> 10</h6>
                                        </div>
                                        <div class="col-6 col-md-6 text-center my-2">
                                            <p class="text-muted m-b-5 f-12"><i class="fas fa-clock"></i> Attempted On :
                                            </p>
                                ...
                                <div
                                    ...
                                    <canvas class="mt-5" id="myChart2" width="582" height="560"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
